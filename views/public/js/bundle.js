...
}; // type is 'success' or 'error' and we have classes in our styles file
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', _context.t0.response.data.message); // console.log(error.response);
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:3003/api/v1/users/updatePassword' : 'http://localhost:3003/api/v1/users/updateMe';
            /* because we use one function to handle to process, we choose url based on condition */
